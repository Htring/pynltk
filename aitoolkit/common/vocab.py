...
class Vocab(object):
    ...
    def __init__(self, name: str = 'basic', init_tokens: dict = None):
        if init_tokens is None:
            init_tokens = SPECIAL_TOKENS
        self.name = name
    ...
    def trim(self, min_freq: int = 2, verbose: Optional[bool] = True):
        """
    ...
    def get_unk_idx(self):
        return self.word2idx.get(self.init_tokens.get("unk_token"))
