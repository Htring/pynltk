...
class Serializer(object):
    ...
    def __init__(self, never_split: List = None, do_lower_case: bool = True, do_chinese_split:  bool = False) -> None:
        """
    ...
    def serialize(self, text: str, never_split: List = None):
        """
    ...
    @staticmethod
    def _whitespace_tokenize(text: str):
        """
        进行基本的空白字符清理和分割
        Arg :
            text (String) : 所需拆分文本
    ...
    @staticmethod
    def _run_strip_accents(text: str):
        """
        从文本中去除重音符号
        Arg :
            text (String) : 所需拆分文本
