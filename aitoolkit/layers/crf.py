...
class CRF(nn.Module):
    ...
    Attributes:
        ...
        transitions (`~torch.nn.Parameter`): Transition score tensor of size
            ``(num_tags, num_tags)``.
    ref: [LMP01] Lafferty, J., McCallum, A., Pereira, F. (2001).
       "Conditional random fields: Probabilistic models for segmenting and
       labeling sequence data". *Proc. 18th International Conf. on Machine
       Learning*. Morgan Kaufmann. pp. 282–289.
    ref: _Viterbi algorithm: https://en.wikipedia.org/wiki/Viterbi_algorithm
    """
    ...
    def decode(self, emissions: torch.Tensor,
        ...
        Args:
            ...
            pad_tag (`int`): Tag at padded positions. Often feature varies in length and
    ...
    def _compute_normalizer(self, emissions: torch.Tensor,
        ...
        for i in range(1, seq_length):
            ...
            # becomes a log-sum-exp: for each sample, entry I store the sum of scores of
